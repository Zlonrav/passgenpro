(function() {
    ...
    const TRIADS = [
        { w1: 'adam', w2: 'douglas', num: 42 },        // 1.  Автостопом по Галактике
        { w1: 'marty', w2: 'doc', num: 88 },           // 2.  Назад в будущее (Герои)
        { w1: 'delorean', w2: 'jigowatt', num: 121 },  // 3.  Назад в будущее (Машина и Сценарий)
