(function() {
    ...
    const TRIADS = [
        ...
        { w1: 'judgment', w2: 'august', num: 29 },     // Терминатор / День и месяц судного дня (2:14 ночи)    
        { w1: 'cyberdyne', w2: 'systems', num: 97},    // Терминавтор / Cyberdyne Systems 1997 год
        { w1: 'sarah', w2: 'connor', num: 65},         // Терминавтор / Сара Коннор, год рождения 1965
        { w1: 'sherlock', w2: 'watson', num: 221 },    // Шерлок Холмс / Бейкер-стрит 221B
        { w1: 'ray', w2: 'bradbury', num: 451 },       // Рэй бредбери / 451 градус по Фаренгейту
        { w1: 'ark', w2: 'librae', num: 47 },          // Борис Штерн / Ковчег 47 Либра
        { w1: 'kings', w2: 'cross', num: 934 },        // Гарри Поттер / Платформа 9 и 3 четверти
        { w1: 'voldemort', w2: 'horcrux', num: 7 },    // Гарри Поттер / Лорд Волан-де-Морт и 7 крестражей
        { w1: 'gringotts', w2: 'vault', num: 687 }     // Гарри Поттер / Сейф №687 в банке «Гринготтс»
    ];
